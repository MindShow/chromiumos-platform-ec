...
#define IN_POWER_GOOD POWER_SIGNAL_MASK(POWER_GOOD)
#define IN_SUSPEND POWER_SIGNAL_MASK(SUSPEND_ASSERTED)
...
static void power_on(void)
{
	...
	gpio_set_flags(power_signal_list[SUSPEND_ASSERTED].gpio,
...
DECLARE_HOOK(HOOK_POWER_BUTTON_CHANGE, powerbtn_changed,
		HOOK_PRIO_DEFAULT);
